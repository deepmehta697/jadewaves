...
PRODUCTS = [
    ...
    },
    {
        ...
        "seo_title": "Quartz Sand Supplier from India | Quartz Grits & Quartz Powder Exporter | Jade Waves Enterprise",
        "meta_description": "Quartz sand supplier from India for ceramics, glass, and engineered stone buyers needing quartz sand, quartz grits, and quartz powder with export supply across Vietnam, Thailand, Malaysia, UAE, and Saudi Arabia.",
