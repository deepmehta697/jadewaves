...
PRODUCTS = [
    ...
    },
    {
        ...
        "hero_copy": "Quartz supplier from India for ceramics, glass, and engineered stone buyers needing quartz sand, quartz grits, quartz powder, and dependable export handling.",
        "short_copy": "Quartz supplier from India for ceramics, glass, and engineered stone.",
