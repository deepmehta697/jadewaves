...
PRODUCTS = [
    ...
    },
    {
        ...
        "seo_title": "Quartz Supplier from India | Quartz Sand, Grits & Powder Exporter",
        "meta_description": "Quartz supplier from India for ceramics, glass, and engineered stone buyers needing quartz sand, grits, and powder supply across Vietnam, Thailand, Malaysia, UAE, and Saudi Arabia.",
